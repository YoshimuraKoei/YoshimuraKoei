...
最近はPhysical AIに着目していて, 面白そうだと思っている.  
...
### データ解析コンペティション
書店の販売データを対象としたデータ解析コンペティションにチームで参加した.
最終的には, 書店・店舗の販売傾向や特徴をもとに, その店舗の特徴に合いそうな書籍を提案する推薦システムを提案. 
購買データだけでなく, 書籍内容や店舗特性に基づいて推薦結果を, ペルソナやジャンルの観点から解釈できる形に昇華させる点を工夫した. 
結果は奮わなかったけれども, データから何かを生み出して提案することの楽しさから, プレゼンで伝えることの難しさまで, 様々なことを学べて良かった. 

### 勤怠管理のモバイルアプリ開発
TypeScript × ReactNative の技術構成で Android, iOS 対応のネイティブアプリケーション開発をチームで行った.
私は主にフロントエンドを担当し, Storybook を用いた UI 開発, CSS, フロントのバリデーションや勤怠ロジックなどを経験しました.
アジャイル開発の形式を取り, 2週間ごとにチームでスプリントレビューを行うのが楽しかった. 
開発の楽しさを知ったのがこのプロジェクトで, 大学3年時でしたが, 免許合宿中でも教習の合間にコミットしていた. 
