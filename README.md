...
設計は私がしていますが, 大部分の開発は Codex が担っています（コードは読みますが）.
現在鋭意開発中です. ボトルネックは人間で, Figma でデザインを作るところで詰まっています（ここがネクスト）.
認証, 入力バリデーション, 画像アップロード, レート制限、運用ログなど, 本番運用を意識した機能も実装しています.
そろそろお名前.comでドメイン購入したいなと思っています.
https://blog-portfolio-tau-ashen.vercel.app/articles
